//Aula 1 anotações
    ...
    // const postEls = document.getElementsByClassName('post');
    // // Parametros podem ser passados com a sintaxe do css no querySelector
    // const headerButtonEls = document.querySelector('#header button');

    // //Mostra no console as informações em Js
    // console.dir();
    // //Mostra no console as informações em HTML
    // console.log();
const contentEl = document.querySelector("main#conteudo");
...
function addPost(post) {
    ...
    tittleEl.innerHTML = post.tittle
    headerEl.appendChild(tittleEl);
